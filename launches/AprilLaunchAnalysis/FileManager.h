...
class FileManager {
    ...
    void getUniqueFileID() {
        ...
        if (!settingsFile.is_open()) {
            std::cout << "Error opening FileManager settings file" << std::endl;
...
public:
    ...
    std::ofstream * createFile(std::string fileName) {
        ...
        if (!newFile->is_open()) {
            logFile << "Error opening " << fileName << "_" << uniqueFileID << " file!" << std::endl;
            std::cout << "Error opening " << fileName << "_" << uniqueFileID << " file!" << std::endl;
        }
        else {
            ...
            logFile << "Opened " << fileName << "_" << uniqueFileID << " at " << dateTimeString << std::endl;
            std::cout << "Opened " << fileName << "_" << uniqueFileID << " at " << dateTimeString << std::endl;
        }
